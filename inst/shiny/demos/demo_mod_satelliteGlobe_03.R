        ...
        (function() {
          ...
          function createSatelliteGlobe02(config) {
            ...
            function createEarth() {
              ...
              /*
                Background base:
                opaco, escribe profundidad y sólo dibuja cara frontal.
              */
              ...
              /*
                Segundo background transparente:
                alphaTest descarta píxeles casi transparentes.
                depthWrite true evita que lo posterior quede sobre lo anterior.
                FrontSide evita dibujar la cara trasera de la esfera.
              */
            ...
            function createSurfaceShell() {
              /*
                Superficie sólida cyan:
                queda por debajo del background base para no teñirlo.
              */
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          tags$br(),
          "La capa transparente usa alphaTest y depthWrite para respetar frente/fondo."
        )
      )
    )
  )

...
ui <- fluidPage(
  ...
  div(
    ...
    div(
      ...
      tags$table(
        ...
        tags$tbody(
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_Sentinel2A_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_Sentinel2A_cone", checked = "checked")),
          ...
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_Sentinel2B_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_Sentinel2B_cone", checked = "checked")),
          ...
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_Landsat8_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_Landsat8_cone", checked = "checked")),
          ...
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_Landsat9_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_Landsat9_cone", checked = "checked")),
          ...
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_GOES16_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_GOES16_cone", checked = "checked")),
          ...
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_GOES18_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_GOES18_cone", checked = "checked")),
          ...
          tags$tr(
            ...
            tags$td(tags$input(type = "checkbox", id = "vis_GOES19_footprint", checked = "checked")),
            tags$td(tags$input(type = "checkbox", id = "vis_GOES19_cone", checked = "checked")),
      ...
      div(
        class = "small-note",
        "Área: aproximación circular instantánea. En Sentinel/Landsat se usa el ancho de barrido real aproximado para la tabla, aunque la huella visual está agrandada para poder verse. En GOES se usa el área visible desde órbita geoestacionaria."
      )
    )
  ),
  ...
  tags$script(HTML("
    ...
    function init() {
      ...
      desiredSatellites.forEach(function(spec) {
        ['sat', 'orbit', 'footprint', 'cone', 'label'].forEach(function(elementName) {
    ...
    function updateSatellites(date) {
      satellitesData.forEach(function(sat) {
        const anyVisible =
          ...
          isElementVisible(sat, 'footprint') ||
          isElementVisible(sat, 'cone') ||
        ...
        sat.footprintObject.visible = isElementVisible(sat, 'footprint');

        if (sat.coneObject) {
          sat.coneObject.visible = isElementVisible(sat, 'cone');
        }
      });
    }

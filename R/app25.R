...
ui <- fluidPage(
  ...
  div(
    ...
    div(
      ...
      div(
        class = "small-note",
        "La línea blanca atraviesa los polos y representa el eje de rotación terrestre. Las huellas de Sentinel/Landsat están aumentadas visualmente para poder verse sobre el globo; la distancia orbital y la posición sí se calculan desde TLE + SGP4. Los conos representan el campo de observación visual hacia la superficie."
      )
    )
  ),

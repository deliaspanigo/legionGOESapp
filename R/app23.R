...
ui <- fluidPage(
  ...
  div(
    ...
    div(
      ...
      div(
        class = "small-note",
        "La línea blanca atraviesa los polos y representa el eje de rotación terrestre. Huella: para Sentinel y Landsat se dibuja el ancho de barrido aproximado; para GOES se dibuja la cobertura visible desde órbita geoestacionaria."
      )
    )
  ),

          ...
          function createSatelliteGlobe02(config) {
            ...
            function init() {
              ...
              /*
                ...
                La rotación con mouse la hacemos manualmente sobre earthGroup,
                siempre alrededor del eje Norte-Sur local de la Tierra.
              */
            ...
            function setupEarthPolarMouseRotation() {
              ...
              dom.addEventListener('pointermove', function(event) {
                ...
                /*
                  Rotación polar real:
                  siempre sobre el eje Y LOCAL de earthGroup.
                  Ese eje Y local es el eje Norte-Sur terrestre.
                */
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          "La rotación con mouse siempre ocurre sobre el eje Norte-Sur terrestre.",
          tags$br(),

...
mod_satelliteGlobe_08_ui <- function(id) {
  ns <- NS(id)
  ...
  tagList(
    tags$head(
      ...
      tags$style(HTML("
        ...
        .earth3d-module-root .earth3d-container {
          width: 100%;
          height: 100%;
          display: block;
        }
        ...
        .earth3d-module-root .earth-gis-panel { left: 15px; }
        .earth3d-module-root .earth-sim-panel { right: 15px; }

        .earth3d-module-root .earth-side-panel h3 {
          margin-top: 0;
          font-size: 20px;
        }

        .earth3d-module-root .earth-side-panel h4 {
          margin-top: 14px;
          margin-bottom: 8px;
          color: #ffcc33;
          font-size: 16px;
        ...
        .earth3d-module-root .gray { color: #aaaaaa; font-weight: bold; }
        .earth3d-module-root .orange { color: #ff9900; font-weight: bold; }

        .earth3d-module-root label { color: white; }
        .earth3d-module-root input,
        .earth3d-module-root select { color: black; }

        .earth3d-module-root .form-group { margin-bottom: 8px; }

        .earth3d-module-root .small-note {
          font-size: 12px;
          opacity: 0.8;
        }

        .earth3d-module-root .manual-time-row {
          display: grid;
        ...
        .earth3d-module-root .menu-toggle-btn:hover {
          background: #ffd966 !important;
          color: #000 !important;
        }

        .earth3d-module-root .menu-toggle-btn::before {
          content: '▾ ';
        }

        .earth3d-module-root .menu-toggle-btn.collapsed::before {
          content: '▸ ';
        }
      "))
    ),
    ...
    tags$script(HTML(paste0("
      (function() {
        ...
        function initEarth(initialTextureUrl, initialOverlayUrl) {
          ...
          const container = document.getElementById(ids.earth3d);
...
mod_satelliteGlobe_08_server <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    observe({
      ...
      if (is.null(refresh_seconds) || length(refresh_seconds) == 0 || is.na(refresh_seconds)) {
        refresh_seconds <- 30
      }

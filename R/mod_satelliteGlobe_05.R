          ...
          function createSatelliteGlobe02(config) {
            ...
            function init() {
              ...
              /*
                ...
                La rotación con mouse la hacemos manualmente:
                - horizontal: rota la Tierra sobre su eje Norte-Sur local.
                - vertical: mueve la cámara hacia polo norte / polo sur.
              */
            ...
            function setupEarthPolarMouseRotation() {
              ...
              dom.addEventListener('pointermove', function(event) {
                ...
                /*
                  ...
                  rota la Tierra sobre su eje Norte-Sur local.
                */
                earthGroup.rotation.y += dx * earthPolarRotationSpeed;

                /*
                  Movimiento vertical:
                  mueve la cámara hacia polo norte / polo sur.
                  No cambia el eje de rotación de la Tierra.
                */
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          "Mouse horizontal: rota la Tierra sobre el eje Norte-Sur.",
          tags$br(),
          "Mouse vertical: mueve la vista hacia polo norte / polo sur."
        )
      )
    )
  )
